...
Record({
    $id: Now.ID['bbb31705874982106fa97627cebb35d6'],
    table: 'sys_data_source',
    data: {
        batch_size: 1000,
        connection_timeout: 0,
        connection_url: 'attachment://sys_data_source:bbb31705874982106fa97627cebb35d6/state import.xlsx',
     ...
     // Add your code here to insert data to import_set_table
        ...
        file_path: 'state import.xlsx',
        file_retrieval_method: 'Attachment',
        format: 'Excel',
        glide_keystore: false,
        header_row: 0,
        import_set_table_name: 'u_imp_tmpl_x_g_dhs_cisa_vm_re_rsc_us_states',
        ldapprobe_result_set_rows: 200,
        maximum_rows: 10000,
        name: 'state import.xlsx (Uploaded)',
        offset: 0,
        oracle_port: '1521',
        oracle_sid: 'orcl',
